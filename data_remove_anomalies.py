...
def find_class_summaries(filename):
    ...
    for class_label in class_labels:
        ...
        print("Rows:", dfC.shape[0] , ", Outliers:" , dfCOutliers.shape[0], ", NonOutliers:", dfCNonOutliers.shape[0] ,'\n')
        class_summary["mean"] = class_mean
        class_summary["outliers"] = dfCOutliers
        class_summary["nonoutliers"] = dfCNonOutliers
...
if __name__ == '__main__':
    ...
    for dataset in sys.argv[1:]:
        ...
        dfFinal = pd.concat([class_summaries[1]["nonoutliers"], class_summaries[2]["nonoutliers"], class_summaries[3]["nonoutliers"]])
        print(dfFinal.shape)
        dfFinal.to_csv("L2testset.csv", header=False)
